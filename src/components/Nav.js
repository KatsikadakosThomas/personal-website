    ...
    return(
        <nav className="absolute glow left-0 top-0 z-[200] h-[60px] sm:h-20 w-full glass shadow font-bold flex flex-row justify-end sm:justify-center items-center">
            ...
            <div className="m-2  hidden sm:block">
                ...
                <Link href="/Thomas_Katsikadakos_resume.pdf" download className="py-1 px-2 mx-5 border-2 border-cyan-400 text-cyan-400 font-bold inline-block  hover:bg-cyan-400 hover:text-white">Resume</Link>

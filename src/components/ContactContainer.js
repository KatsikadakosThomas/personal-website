...
function ContactContainer() {
    ...
    return (
        <article className={`glass max-w-[100%] md:max-w-[70%] lg:max-w-[60%] p-5 mt-[30px]  max-h-[70vh] sm:h-full overflow-auto rounded shadow-xl z-30 flex flex-col md:flex-row  items-center  ${state ? "show" : "noshow"} rounded-2xl ${inter.className} `}>
